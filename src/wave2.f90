...
!     Write out translation and rotation matrices to REST?
	...
	CALL FIBG3(BASE,SUF,origin,NN,NTOT,NANS,NRXF,NANPart,particles_G, NCN, &
        ...
        CALL MPI_ALLREDUCE(MYMAXZ,MAXX,1,MPI_DOUBLE_PRECISION,MPI_MAX,MPI_COMM_WORLD,ierr)
        CALL MPI_ALLREDUCE(MYMAXY,MAXY,1,MPI_DOUBLE_PRECISION,MPI_MAX,MPI_COMM_WORLD,ierr)
        CALL MPI_ALLREDUCE(MYMAXX,MAXZ,1,MPI_DOUBLE_PRECISION,MPI_MAX,MPI_COMM_WORLD,ierr)
